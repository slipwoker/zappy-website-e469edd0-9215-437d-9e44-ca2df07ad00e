document.addEventListener('DOMContentLoaded', function () {
  ...
  document.body.addEventListener('click', function (e) {
    ...
    const navbarEl = document.querySelector('nav, .navbar, [class*="navbar"], header');
  ...
  if (contactForm) {
    ...
    function getErrorMessage(field, errorType) {
      const label = field.closest('label, .form-group, .field-wrapper')
        ? (field.closest('label, .form-group, .field-wrapper').querySelector('label') || field)
        : field;
    ...
    function showError(field, message) {
      ...
      errorEl.style.cssText = 'display:block;color:#dc3545;font-size:0.85em;margin-top:4px;';
  ...
  const animationCandidates = document.querySelectorAll(animationSelectors.join(', '));

  if (animationCandidates.length > 0 && 'IntersectionObserver' in window) {
    ...
    if (!prefersReducedMotion) {
      ...
      animationCandidates.forEach(function (el, index) {
      ...
      animationCandidates.forEach(function (el) {
        el.classList.add(OBSERVE_CLASS, ANIMATION_CLASS);
      });
    }
  } else if (animationCandidates.length > 0) {
    animationCandidates.forEach(function (el) {
      el.classList.add(OBSERVE_CLASS, ANIMATION_CLASS);
    });
  }
...
(function() {
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            var payload = {
                websiteId: 'e469edd0-9215-437d-9e44-ca2df07ad00e',
                name: resolvedName,
                email: resolvedEmail,
            ...
            if (result.success) {
                ...
                if (result.thankYouPagePath && result.ticketNumber) {
                    ...
                    if (isPreview && window.ZAPPY_CONFIG) {
                        var wid = window.ZAPPY_CONFIG.websiteId || 'e469edd0-9215-437d-9e44-ca2df07ad00e';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = 'e469edd0-9215-437d-9e44-ca2df07ad00e';
